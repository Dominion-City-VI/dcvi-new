...
//   useEffect(() => {
//     if (departmentStatus === 'success' && departmentData && Array.isArray(departmentData)) {
//       const departmentArr = departmentData.map((item: { name: any; id: any }) => ({
//         label: item.name,
//         value: item.id
//       }));
...
//                       // required={true} // only if you want to force it
//                     />
//                   )}
//                 /> <br/>
//                 <FormField
