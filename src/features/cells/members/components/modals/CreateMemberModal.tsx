...
export default function CreateMemberModal() {
  const {
    ...
    AppConfigStore: { toggleModals, isOpen, cellModal }
  } = useStore();
  ...
  const form = useForm({
    mode: 'onSubmit',
    defaultValues: {
      zone: cellModal.zonalId ?? userExtraInfo.zonalId,
      cell: cellModal.cellId ?? userExtraInfo.cellId
    },
              ...
              <FormField
                ...
                render={() => (
                  <FormItem>
                    ...
                    <FormControl className="mb-4 flex flex-col space-y-2 md:flex-row md:space-y-0 md:space-x-3">
                      <RadioGroup
                        onValueChange={(value) => {
                          if (value === 'assistant') {
                            form.setValue('isAssistantCellLeader', true);
                          } else if (value === 'leader') {
                            form.setValue('isConsideredLeader', true);
                          }
                        }}
                      ...
                      >
                        <div className="flex space-x-1">
                          ...
                          <FormLabel htmlFor="member" className="font-normal">
                            Member
                          </FormLabel>
                        </div>
                        <div className="flex space-x-1">
                          <RadioGroupItem id="assistant" value="assistant" />
                          <FormLabel htmlFor="assistant" className="font-normal">
                            Assistant Leader
                          </FormLabel>
                        </div>

                        <div className="flex space-x-1">
                          <RadioGroupItem id="leader" value="leader" />
                          <FormLabel htmlFor="leader" className="font-normal">
                            Cell leader
                          </FormLabel>
                        </div>
                      </RadioGroup>
