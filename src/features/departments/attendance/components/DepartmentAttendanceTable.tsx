...
const DepartmentAttendanceTable = ({ cellAttendance, placeholder }: DataTableProps) => {
  ...
  const separateHeaders = (headers: Header<TDeptAttendanceItem, unknown>[]) => {
  ...
  const separateCells = (cells: Cell<TDeptAttendanceItem, unknown>[]) => {
...
export default observer(DepartmentAttendanceTable);
