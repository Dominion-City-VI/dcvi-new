...
const DataTableToolbar = () => {
  const {
    ZoneStore: { zoneAttendanceQuery, applyAttendanceFilter, resetAttendanceFilter, hasFilter }
  } = useStore();

  const form = useForm<TAttendanceFilterSchema>({
    defaultValues: { ...zoneAttendanceQuery },
    mode: 'onSubmit',
  ...
  console.log(zoneAttendanceQuery);
